...
## Exploring Habit Data Insights

The Habit Data and Location History feature is a powerful tool that provides valuable insights into **your pet's** activities and overall habit. 

By following a few simple steps, you can access a wealth of information right at your fingertips.

**Easy Steps to Access Habit Data:**

1. Open the WAGGURACY App:
  
  Open the **WAGGURACY app** on your Android or iOS device and log in.
2. Navigate to the Habit Tab:

  Tap **Habit**.
3. Review Habit Data History:

  You can now choose the **desired time frame** for reviewing their habit data history.

  ![Health](/img/health/time.jpg)

By following these simple steps, you'll be able to access and review your pet's habit data with ease.
