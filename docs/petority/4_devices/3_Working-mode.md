...
When PHAST 1 is within the Home Fence, it will automatically switch to At Home mode. You will receive a notification confirming your pet has safely returned home.

In this mode, GPS tracking is disabled to significantly reduce power consumption, helping extend battery life and eliminate range anxiety.

## Out of Home Mode:

When PHAST 1 exits the Home Fence, it will automatically switch to Out of Home mode and trigger a fence alert notification.
