...
This Privacy Policy applies to your access and use of Petaverse Offerings made available in United States, This United States Privacy Policy only applies to access and use of the Petaverse Offerings within the United States, and does not apply to any other data gathered or used by us, including through websites and mobile applications not listed above or to the information practices from other countries. 

This Privacy Policy is incorporated into and made a part of the Term of Services. By using Petaverse Offerings, you agree that we may treat your information in the ways we describe in this Privacy Policy. If you do not agree with any term of this Privacy Policy or the Term of Services, you may not use Petaverse Offerings. 
...
+ **Device Data**: We may collect information related to the handheld terminal running devices, such as the operating system type and version, manufacturer and model of the mobile device, screen resolution, RAM and disk size, CPU usage, IP address, unique identifiers (including identifiers for advertising purposes), language settings, city, state, and general location information.
...
+ **Location Data**: If you authorize our service to access your device's location (for automatic connection to your devices), we collect your location information to provide our services (allowing our users to track their pet's location). We actively collect location information (such as using GPS or Bluetooth) and passively collect location information (such as using Wi-Fi).
...
The purpose of collecting personal information is to provide you with our products/services and ensure compliance with laws. You consent to processing and disclosing personal information as outlined in this Privacy Policy to service providers and business partners.
...
+ **Direct Marketing**: We may send you personalized marketing communications based on the personal information you provided (such as pet information, order details), using your email address and account of our Apps for promotional materials related to our products and services.
...
+ **Analytics**: To assist in understanding user activities on the service, including popular and unpopular pages and user interactions with our emails.
...
We may share your personal information with third parties to provide requested products or services. Rest assured, we will only share your data with authorized suppliers or agents for the outlined purposes in this Privacy Policy.
...
+ Log in, Log out, and Deactivate your Account in our Websites and Apps: You have the option to log in, log out, and deactivate your account.
...
+ Enable or Disable Location Access: You can disable our access to your device's precise location in your mobile device settings. However, please note that if you disable our access to your device's Bluetooth connection, we may not be able to provide location tracking services for your devices.
...
**RefRefusal to Provide Location Information:** 

We need your data for specific services, especially concerning your mobile device's Bluetooth or WiFi connection, enabling us to connect to your devices. Failure to provide essential info (including Bluetooth and WiFi connections) may impact our ability to offer location tracking services.
...
+ Personal information we collect about you if you are a resident of California, USA;
+ Rights afforded to you under the following acts:
  + “California Consumer Privacy Act” (“CCPA”);
  + “California Online Privacy Protection Act” (“CalOPPA”).

Types and Use of Data
+ For more details about the personal information we have collected over the last 12 months, including the categories of sources, please see section “Information Collection”.
+ We collect this personal information for the business and commercial purposes described in section “Use of Your Personal Information”.
+ We share this information with the categories of third parties described in section “Sharing Your Personal Information”.
+ We use third-party cookies for our advertising purposes as further described in section “Sharing Your Personal Information”.
+ The effective date of this Privacy Policy and information on changes is described on the first page of this Privacy Policy.

Specific Notices.
+ Special Rights under the CCPA. Subject to certain limitations, the CCPA affords to you the right to know more details about the categories or specific parts of the personal information we collect, including details on how:
  + We use and disclose personal information;
  + Your personal information can be deleted;
  + You can object to the processing of personal information (“Opt-Out”).
+ Do Not Track-Clause under the CalOPPA. The Services do not respond to "Do Not Track" signals.

Requests under the CCPA. You may make a request pursuant to your rights under the CCPA by contacting us at support@wagguracy.com, e.g. if you want to object to the processing of your personal information or agree to such processing through your legal guardian if you are under 18 years old. We will verify your request using the information associated with your User Account, including email address. Government identification may be required. Consumers can also designate an authorized agent to exercise these rights on their behalf.
...
We may update this privacy policy at any time. In case of significant changes, we will notify you via email or by posting on our Apps. The changes will be effective upon publication. Your continued use of the service after the effective date will be considered acceptance of the updated policy.

## Contact Us
If you have any comments, questions, or concerns about this Privacy Policy or Petaverse's handling of your personal information, please email us. We will respond promptly.

**Email**: support@wagguracy.com
